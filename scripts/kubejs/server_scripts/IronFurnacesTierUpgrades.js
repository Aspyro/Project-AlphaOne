// Removes all the furnaces upgrades due to the Stone to Iron Furnace Upgrade getting in conflict with FastFurnace mod

console.info('Removes all the furnaces upgrades due to the Stone to Iron Furnace Upgrade getting in conflict with FastFurnace mod')
